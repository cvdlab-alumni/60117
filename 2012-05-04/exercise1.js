...
var ali_cpm = STRUCT(AA(POLYPOINT)([ali_cp_c0,ali_cp_d1,ali_cp_s1,ali_cp_d2,ali_cp_s2,ali_cp_d3,ali_cp_s3]));
DRAW(ali_cpm);

var ali_cc = AA(BEZIER(S0))([ali_cp_d3,ali_cp_d2,ali_cp_d1,ali_cp_c0,ali_cp_s1,ali_cp_s2,ali_cp_s3]);
var ali_ccm = STRUCT(CONS(AA(MAP)(ali_cc))(ali_dom1D));
DRAW(ali_ccm);

var ali_sup = BEZIER(S1)(ali_cc);
var ali = MAP(ali_sup)(ali_dom2D);
DRAW(ali);